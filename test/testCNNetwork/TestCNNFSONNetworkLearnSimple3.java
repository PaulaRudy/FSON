...
public class TestCNNFSONNetworkLearnSimple3 {
	...
	public void setUp() throws Exception {
		...
		Layer l0 = new Layer(4,4,1,2,2,1,4,2,0, LayerType.MAXPOOL);
		l0.initLayer();
		...
		PrintStream outStream = new PrintStream(new FileOutputStream("simple3.csv"));
		System.setOut(outStream);

		long startTime = System.nanoTime();
		
		// Actually call the learning function.
		FSONNetwork.learn(1, layers, out, input, 500, dictionary, true, "TestCNNFSONNetworkLearnSimple3");
	...
	public void test() throws Exception {
		...
		PrintStream resultStream = new PrintStream(new FileOutputStream("simple3test.csv"));
