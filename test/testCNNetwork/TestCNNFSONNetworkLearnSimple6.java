...
public class TestCNNFSONNetworkLearnSimple6 {
	...
	public void setUp() throws Exception {
		...
		PrintStream outStream = new PrintStream(new FileOutputStream("simple6.csv"));
		System.setOut(outStream);
		
		long startTime = System.nanoTime();
		
		// Actually call the learning function.
		FSONNetwork.learn(1, layers, out, input, 500, dictionary, true, "TestCNNFSONNetworkLearnSimple6");
	...
	public void test() throws Exception {
		...
		PrintStream resultStream = new PrintStream(new FileOutputStream("simple6test.csv"));
