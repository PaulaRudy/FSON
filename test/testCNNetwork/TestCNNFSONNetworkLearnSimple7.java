...
public class TestCNNFSONNetworkLearnSimple7 {
	...
	public void setUp() throws Exception {
		...
		PrintStream outStream = new PrintStream(new FileOutputStream("simple7.csv"));
		System.setOut(outStream);
		
		long startTime = System.nanoTime();
		
		// Actually call the learning function.
		FSONNetwork.learn(1, layers, out, input, 500, dictionary, true, "TestCNNFSONNetworkLearnSimple7");
	...
	public void test() throws Exception {
		...
		PrintStream resultStream = new PrintStream(new FileOutputStream("simple7test.csv"));
